...
**Status**: as of 2026-07-20, all core pages (Foods, Today, Weight, Stats, Settings) are built and deployed to Vercel. Treat this as a working, deployed app, not a WIP — check git history before assuming something is unbuilt, since each commit corresponds to one feature area with a detailed message.
